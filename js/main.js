...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Inicializar calculadora de presupuestos
    ...
    /**
     * Inicializa la calculadora de presupuestos
     */
    function initBudgetCalculator() {
        ...
        calculatorForm.addEventListener('submit', function(e) {
            ...
            // Inicializar chatbot con los datos del presupuesto
            if (typeof window.initChatbot === 'function') {
        ...
        // Función para mostrar el presupuesto estimado
        function showEstimate(amount) {
            const formatter = new Intl.NumberFormat('es-ES');
            const estimateElement = calculatorResult.querySelector('.estimate');
    ...
    function initTestimonialsCarousel() {
        ...
        // Asegurarse de que todos los testimonios estén visibles pero solo el primero activo
        ...
        function showTestimonial(index) {
            ...
            testimonials.forEach(testimonial => {
                testimonial.classList.remove('active');
                // Primero quitamos la clase active para la transición
                setTimeout(() => {
                    testimonial.style.display = 'none';
            ...
            // Usar setTimeout para que la transición funcione
            setTimeout(() => {
        ...
        const stopAutoplay = () => {
            ...
            // Reiniciar después de 15 segundos de inactividad
        ...
        // Añadir clase active al primer testimonio para la animación inicial
        testimonials[0].classList.add('active');
    }
});
